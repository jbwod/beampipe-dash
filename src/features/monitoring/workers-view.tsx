...
function formatWorkerLabels(value: unknown) {
  if (!value || typeof value !== "object" || Array.isArray(value)) return "none";
  const labels = Object.entries(value as Record<string, unknown>).map(([key, item]) => `${key}=${String(item)}`);
