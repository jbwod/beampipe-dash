...
const positive = new Set(["ok", "ready", "healthy", "active", "running", "completed", "configured", "reachable", "enabled", "submitted", "staged", "verified", "valid", "complete", "settled", "new", "sent"]);
